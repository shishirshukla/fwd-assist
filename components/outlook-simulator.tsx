    ...
    <div className="flex min-h-screen flex-col bg-[#f3f2f1] text-[#201f1e]">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <main className="flex min-w-0 flex-1 flex-col p-3 sm:p-5">
          ...
          <section className="flex min-h-0 flex-1 flex-col overflow-hidden rounded-lg border border-[#edebe9] bg-white shadow-sm">
            <div className="flex flex-wrap items-center gap-2 border-b border-[#edebe9] bg-[#faf9f8] px-3 py-2">
              <Button
                type="button"
                className="bg-[#0f6cbd] text-white hover:bg-[#115ea3]"
                onClick={handleSend}
              >
      ...
      <Dialog open={formOpen} onOpenChange={setFormOpen}>
        <DialogContent className="sm:max-w-xs" showCloseButton>
          <DialogHeader>
            <DialogTitle>Classify this forward</DialogTitle>
            <DialogDescription>
              Send is paused. Fill in these three fields, then the message can go
              out.
            </DialogDescription>
          </DialogHeader>
          <ForwardMetadataForm
